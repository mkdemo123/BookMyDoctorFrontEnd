...
const Navbar = () => {
    ...
    return (
        <div>
            <nav className={`navbar fixed-top navbar-expand-md navbar-black navbar-dark bg-black ${location.pathname==='/'? 'bg-primary': 'bg-dark'}`} aria-label="Navbar">
                <div className="container">
                    <Link to="/" className="navbar-brand" ><span> <img src="./logo512.png" height={40}alt="bug" />Book My Doctor</span></Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarsExample04">
                        <ul className="navbar-nav me-auto mb-2 mb-md-0">
                            ...
                            <Link to="/ourdoctor" className="nav-link px-2 text-white"><li>Our Doctors</li></Link>
